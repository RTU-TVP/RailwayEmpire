...
namespace Data.Static.Trains
{
    ...
    public class TrainConfigurationScriptableObject : ScriptableObject
    {
        ...
        [field: SerializeField] public float WaitingTimeForNextTrainMin { get; private set; }
        [field: SerializeField] public float WaitingTimeForNextTrainMax { get; private set; }
